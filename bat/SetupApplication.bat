...
:: Android packaging
set AND_CERT_NAME="StarlingTest"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\StarlingTest.p12
...
set IOS_PROVISION=cert\StarlingTest.mobileprovision
...
set APP_ID=air.StarlingTest

:: Output packages
set DIST_PATH=dist
set DIST_NAME=StarlingTest
